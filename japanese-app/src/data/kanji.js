const Data = [
  ...
  },
  {
    ...
    readings_kun: ['もっ.て'],
    wk_level: 7,
    wk_meanings: ['From', 'Since', 'Compared With', 'By Means Of'],
    wk_readings_on: ['い'],
    wk_readings_kun: [],
  ...
  },
  {
    ...
    readings_kun: ['つが.い'],
    wk_level: 8,
    wk_meanings: ['Ordinal Number', 'Turn'],
    wk_readings_on: ['ばん'],
    wk_readings_kun: [],
  ...
  },
  {
    ...
    readings_kun: ['ことば'],
    wk_level: 19,
    wk_meanings: ['Part Of Speech', 'Words', 'Grammar Particle'],
    wk_readings_on: ['し'],
    wk_readings_kun: [],
